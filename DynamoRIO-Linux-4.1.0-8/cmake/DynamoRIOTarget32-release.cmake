...
SET_TARGET_PROPERTIES(dynamorio PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib32/release/libdynamorio.so.4.1"
  IMPORTED_SONAME_RELEASE "libdynamorio.so.4.1"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS dynamorio )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_dynamorio "${_IMPORT_PREFIX}/lib32/release/libdynamorio.so.4.1" )
...
SET_TARGET_PROPERTIES(drinjectlib PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib32/libdrinjectlib.so"
...
SET_TARGET_PROPERTIES(drdecode PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib32/release/libdrdecode.a"
  )
...
SET_TARGET_PROPERTIES(drconfiglib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib32/libdrconfiglib.so"
...
SET_TARGET_PROPERTIES(drcontainers PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrcontainers.a"
  )
...
SET_TARGET_PROPERTIES(drutil PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrutil.so"
...
SET_TARGET_PROPERTIES(drsyms PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrsyms.so"
...
SET_TARGET_PROPERTIES(drwrap PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrwrap.so"
...
SET_TARGET_PROPERTIES(drx PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dynamorio"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrx.so"
...
SET_TARGET_PROPERTIES(drmgr PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrmgr.so"
...
SET_TARGET_PROPERTIES(bbcov PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/lib32/release/libbbcov.so"
  IMPORTED_SONAME_RELEASE "libbbcov.so"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS bbcov )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_bbcov "${_IMPORT_PREFIX}/tools/lib32/release/libbbcov.so" )
...
SET_TARGET_PROPERTIES(bbcov2lcov PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/bin32/bbcov2lcov"
  )
