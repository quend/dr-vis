...
SET_TARGET_PROPERTIES(dynamorio PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/debug/libdynamorio.so.4.1"
  IMPORTED_SONAME_DEBUG "libdynamorio.so.4.1"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS dynamorio )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_dynamorio "${_IMPORT_PREFIX}/lib64/debug/libdynamorio.so.4.1" )
...
SET_TARGET_PROPERTIES(drinjectlib PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/libdrinjectlib.so"
...
SET_TARGET_PROPERTIES(drconfiglib PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/libdrconfiglib.so"
...
SET_TARGET_PROPERTIES(bbcov PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/tools/lib64/debug/libbbcov.so"
  IMPORTED_SONAME_DEBUG "libbbcov.so"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS bbcov )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_bbcov "${_IMPORT_PREFIX}/tools/lib64/debug/libbbcov.so" )
...
SET_TARGET_PROPERTIES(bbcov2lcov PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/tools/bin64/bbcov2lcov"
  )
